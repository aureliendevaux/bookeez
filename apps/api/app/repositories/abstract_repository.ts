...
export default abstract class AbstractRepository {
	...
	protected $selectQuery<T extends Table>({
		table,
		transaction,
	}: {
		table: T;
	...
	protected $updateQuery<T extends Table>({
		table,
		transaction,
	}: {
		table: T;
	...
	protected $deleteQuery<T extends Table>({
		table,
		transaction,
	}: {
		table: T;
	...
	protected $findAll<T extends Table>({
		table,
		transaction,
	}: {
		table: T;
		...
		return {
			...
			selectTakeFirst: <S extends SelectReturn<T>>(...selection: ReadonlyArray<S>) =>
