...
export const buttonVariants = cva<Variants>(
	'inline-flex items-center gap-2 rounded-md border-none font-medium transition-colors focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2',
	{
		compoundVariants: [
			...
			{
				className: 'outline-success-400',
				intent: 'success',
			},
			{
				className: 'outline-danger-400',
				intent: 'danger',
			},
			{
				className: 'outline-neutral-400',
			...
			{
				className: 'text-neutral-500 hover:bg-neutral-50',
				disabled: false,
				intent: 'light',
				variant: 'ghost',
			},
			...
			{
				className: 'border-b-neutral-300',
				disabled: true,
				iconOnly: true,
				variant: 'underline',
			},
